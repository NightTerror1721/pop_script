 ...
 * @author Asus
 */
public final class UInt32 extends LongData<UInt32>
{
    ...
    @Override public UInt32 add(UInt32 v) { return new UInt32(value + v.value); }
    @Override public UInt32 subtract(UInt32 v) { return new UInt32(value - v.value); }
    @Override public UInt32 multiply(UInt32 v) { return new UInt32(value * v.value); }
    @Override public UInt32 divide(UInt32 v) { return new UInt32(value / v.value); }
    @Override public UInt32 module(UInt32 v) { return new UInt32(value % v.value); }
    @Override public UInt32 abs() { return new UInt32(Ops.abs(value)); }
    ...
    public static final UInt32 valueOf(Data data) { return new UInt32(data.longValue()); }
    public static final UInt32 valueOf(Number number) { return new UInt32(number.longValue()); }
