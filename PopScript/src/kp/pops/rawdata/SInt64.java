 ...
 * @author Asus
 */
public final class SInt64 extends LongData<SInt64>
{
    ...
    @Override public SInt64 add(SInt64 v) { return new SInt64(value + v.value); }
    @Override public SInt64 subtract(SInt64 v) { return new SInt64(value - v.value); }
    @Override public SInt64 multiply(SInt64 v) { return new SInt64(value * v.value); }
    @Override public SInt64 divide(SInt64 v) { return new SInt64(value / v.value); }
    @Override public SInt64 module(SInt64 v) { return new SInt64(value % v.value); }
    @Override public SInt64 abs() { return new SInt64(Ops.abs(value)); }
    ...
    public static final SInt64 valueOf(Data data) { return new SInt64(data.longValue()); }
    public static final SInt64 valueOf(Number number) { return new SInt64(number.longValue()); }
