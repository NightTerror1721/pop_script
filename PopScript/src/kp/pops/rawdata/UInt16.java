 ...
 * @author Asus
 */
public final class UInt16 extends IntData<UInt16>
{
    ...
    @Override public UInt16 add(UInt16 v) { return new UInt16(value + v.value); }
    @Override public UInt16 subtract(UInt16 v) { return new UInt16(value - v.value); }
    @Override public UInt16 multiply(UInt16 v) { return new UInt16(value * v.value); }
    @Override public UInt16 divide(UInt16 v) { return new UInt16(value / v.value); }
    @Override public UInt16 module(UInt16 v) { return new UInt16(value % v.value); }
    @Override public UInt16 abs() { return new UInt16(Ops.abs(value)); }
    ...
    public static final UInt16 valueOf(Data data) { return new UInt16(data.intValue()); }
    public static final UInt16 valueOf(Number number) { return new UInt16(number.intValue()); }
